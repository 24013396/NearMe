...
<html>
    ...
    <body>
        ...
        <h2 align="center" bgcolor="Violet">shaik Hazeedmasthan(24013396)</h2>
        <center>
        <img src="map.png" usemap="#image-map">

        <map name="image-map">
            <area target="" alt="nellore" title="My Home Town" coords="100,100,900,900" href="Home.html" shape="rect">
